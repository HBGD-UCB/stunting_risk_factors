params <-
structure(list(roles = c("exclude", "strata", "id", "W", "A", 
"Y"), data = structure(list(type = "web", uri = "https://raw.githubusercontent.com/HBGD-UCB/longbowRiskFactors/master/inst/sample_data/birthwt_data.csv"), .Names = c("type", 
"uri")), nodes = structure(list(strata = c("study_id", "mrace"
), id = "subjid", W = list(), A = "parity_cat", Y = "haz01"), .Names = c("strata", 
"id", "W", "A", "Y")), script_params = structure(list(parallelize = structure(list(
    input = "checkbox", value = FALSE), .Names = c("input", "value"
)), baseline_level = structure(list(input = "character", value = "[1,2)"), .Names = c("input", 
"value"))), .Names = c("parallelize", "baseline_level")), output_directory = ""), .Names = c("roles", 
"data", "nodes", "script_params", "output_directory"))
